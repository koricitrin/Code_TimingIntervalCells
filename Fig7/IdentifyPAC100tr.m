function IdentifyPAC100tr(path, savepath)
        ...
        isPAC = [];
            ...
            for j = 1:length(Neurons)
                ...
                neu_id = [neu_id ; k];
                 ...
                 RiseThres = 3/2;
                DownThres = 2/3; 
               if ratio0to1BefRun_LL < RiseThres
                  continue

               else ratio0to1BefRun_LL > RiseThres;
                ...
                if ratio0to1BefRun_Lick < DownThres;
            ...
            NumPAC = length(isPAC);
            PropPAC =  NumPAC/length(Neurons);
          
            cd(save_path)
            save_path1 = [filename(1,1:16) 'PAC'  SaveStr '.mat'];
            save(save_path1, 'isPAC', 'NumPAC', 'PropPAC');
    end
