...
% 
%%%Sort by First lick 
    StartCued = StartCue(2:351)
    firstLick = firstLick(2:351); 
...
cd('Z:\Kori\immobile_code\RiseDown\tables\2025-05to05\Variable\D9\')
...
% % 
      ...
      cd(path)
      foldername = ['IndLLtoFLickPlot_LickOn_sort'];   
     mkdir(foldername)  
...
NeurSel = 340
      for u =  1:size(NeurSel,1)
             % b =u;
            b = NeurSel(u)
             Neuron = NeurData{b}(1:350,500:end); %%500 = -2
             data =   [flicks', Neuron];
