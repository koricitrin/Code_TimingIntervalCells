...
path = ['Z:\Kori\immobile_code\Ephys\0403\']
cd(path)
load('FR_ArrayNormTogether_-2-9.mat')

    save_path2 = ['Z:\Kori\immobile_code\Ephys\0403\'];
...
nWarp =  find(timeStepRunNew == 7) - find(timeStepRunNew == 0);
...
save('TimeWarpMatrix.mat', 'warpedCa4555', 'warpedCa67')
