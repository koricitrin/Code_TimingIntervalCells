function makeFRprofileTable_RiseLLDownL_Ephys(paths, filename, save_path1, tablepath, PAC)
...
% 
  ...
  avgFR_profile_56_NotNorm = [];
    ...
    for i = 1:size(paths,1)
        ...
        InfoPath = [path_i  '_Info.mat'];
        load(InfoPath)
        AllNeur = 1:length(autoCorr.isInterneuron);
        Neurons = AllNeur(logical(autoCorr.isInterneuron));
        end
